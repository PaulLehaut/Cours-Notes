...
\sskip 
On suppose que $\Omega$ est connexe, la fonction $f:\Omega\longrightarrow\C$ admet une primitive si et seulement si elle est continue si pour tout chemin fermé rectifiable $\gamma$:
$$\int_\gamma f =0.$$
\sskip 
