...
On s'intéresse à la moyenne $\mu$ dans un modèle Gaussien qu'on estime classiquement avec $\bar X_n$. La loi de $\bar X_n$ selon $\Prob_{\mu,\sigma^2}$ est $\mc N(\mu,\sigma^2)$. Il vient alors:
